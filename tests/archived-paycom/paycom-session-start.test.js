...
const cdp = require('../../integrations/paycom/provider/auth/cdp');
const { CLIENT_LANDING_PATH, LOGIN_URL, LOGIN_ACTION_URL, SECURITY_QUESTION_PATH,
  TIMECARD_SEARCH_URL, SNAPSHOT } = require('../../integrations/paycom/provider/auth/adapter');
...
async function fixture(t, scenario, run, { application = false, nativeInput = scenario === 'expired' } = {}) {
  ...
  const modulePath = require.resolve('../../integrations/paycom/provider/auth/adapter');
