...
function createDashboardServer(options = {}) {
  ...
  const dashboards=options.dashboards || ((_session,identity)=>{const value=require('../../core/updates/dashboard').readDashboard(options.publicRoot || DEFAULT_PUBLIC_ROOT,'core');return identity?{product:value.product,digest:value.digest}:value;});
